function  [comb,soll]=analisi_carichi1975c(ldeck,l_marciapiede,...
    l_sedestrad,h_girder,h_bent,h_slab,Pp_bent,Pp_bentcap,tribl,tribl_sism,Ppdeck,Lx_pier,Ly_pier,categoria_ponte,Ss,sigma_r,d_bear,piertype)
 
 %% INPUT elaboration

E_pila=(18000*(sigma_r*10)^0.5)*10^(-1); %MPa modulo di elasticità longitudinale del cls della pila
...
[Fx_seism,Fy_seism,Fv_seism, My_seism,Mx_seism]=seismloadanalysis75(Npp,h_bent,Pp_bent,Pp_bentcap,tribl_sism,Ppdeck,Lx_pier,Ly_pier,Ss,piertype,beartype,E_pila,1);
