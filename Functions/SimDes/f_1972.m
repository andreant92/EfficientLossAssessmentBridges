function [nf_x_def,fi_x_def,fi_staffey_def,passo_staffe_def,nb_y_def,nf_y_def,fi_y_def,fi_staffex_def,nb_x_def]=f_1972(Lx_pier,Ly_pier,n,Nsd,Msd_x,Msd_y,Vsd_x,Vsd_y,sigmac_r,sigmas_adm)
...
%-L'armatura longitudinale deve essere minore del 0.5% di Ac_min
...
R=(As_tot>0.006*Ac_min && As_tot<0.5*Ac_min && As_tot>0.003*(a*b));
